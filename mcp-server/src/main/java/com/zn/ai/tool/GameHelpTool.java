...
public class GameHelpTool {
    ...
    public boolean addUserGameWish(@McpToolParam(description = "用户名称") String userName,
        ...
        return userGameWishService.addUserGameWish(cmd);
    }

    @McpTool(name = "getUserGameWishList", description = "根据用户信息,查询用户游戏心愿单数据")
    public List<UserGameWishVO> getUserGameWishList(@McpToolParam(description = "用户名称") String userName,
        ...
        return userGameWishService.getUserGameWishList(cmd);
    }
